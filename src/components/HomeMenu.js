  ...
  return (
    <section className="max-w-6xl mx-auto">
      <div className="text-center m-4">
        <h3 className="text-black font-semibold mt-20">Check out</h3>
        <h2 className="text-brand font-bold text-4xl">Menu</h2>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-sm sm:text-base lg:text-lg xl:text-xl">
        ...
        >
          <img src="/pic2.jpg" alt="menu item image" className="rounded-t-lg" />
